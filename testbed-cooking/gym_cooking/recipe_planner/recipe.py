...
class TomatoLettuceSoup(Recipe):
    def __init__(self):
        Recipe.__init__(self, 'TomatoLettuceSoup', 500, 15)
        self.add_ingredient(Tomato(state_index=4))
        self.add_ingredient(Lettuce(state_index=4))
        self.add_goal()
...
class OnionTomatoSoup(Recipe):
    def __init__(self):
        Recipe.__init__(self, 'OnionTomatoSoup', 500, 15)
        self.add_ingredient(Onion(state_index=4))
        self.add_ingredient(Tomato(state_index=4))
        self.add_goal()
...
class OnionLettuceSoup(Recipe):
    def __init__(self):
        Recipe.__init__(self, 'OnionLettuceSoup', 500, 15)
        self.add_ingredient(Onion(state_index=4))
        self.add_ingredient(Lettuce(state_index=4))
        self.add_goal()
...
class FullSoup(Recipe):
    def __init__(self):
        Recipe.__init__(self, 'FullSoup', 500, 20)
        self.add_ingredient(Tomato(state_index=4))
        self.add_ingredient(Lettuce(state_index=4))
        self.add_ingredient(Onion(state_index=4))
        self.add_goal()
